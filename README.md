...
<img src="https://img.shields.io/badge/Version-2.4.16-6366f1?style=for-the-badge&logoColor=white" alt="Version">
...
#### 📋 Audit Logs & Analysis Enhancements
- **Advanced Audit Log Filtering**: The Audit Log user interface has been completely overhauled to support multi-column filtering. Users can now click on column headers to filter logs by Username, Action, Date Ranges, Target, and IP Address.
- **Dynamic API Queries**: The `/api/audit_log` endpoint and internal audit services have been updated to support complex query parameters generated by the new UI.
- **Auto-Refresh & Export**: Added seamless auto-refresh toggles and improved CSV export capabilities for filtered audit data.
